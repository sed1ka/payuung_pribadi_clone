...
import 'package:payuung_pribadi_clone/features/personal_information/biodata/status_pernikahan/status_pernikahan_bottomsheet.dart';
import 'package:payuung_pribadi_clone/utils/formatter.dart';
import 'package:payuung_pribadi_clone/utils/page_navigator.dart';


class StatusPernikahanSelector extends StatelessWidget {
  const StatusPernikahanSelector({
    super.key,
  ...
  Future<void> selectData(
    ...
    final dynamic res = await showKreduitModalBottom(
      ...
      builder: (_) => BlocProvider.value(
        value: bloc,
        child: const StatusPernikahanBottomSheet(),
      ),
    );
  ...
  Widget build(BuildContext context) {
    final StatusPernikahanBloc bloc = BlocProvider.of(context);
    ...
    return BlocConsumer(
      ...
      builder: (_, __) => DataSelectorTextField(
        ...
        onTap: () => bloc.add(OpenSelectorStatusPernikahan()),
      ),
    );
  }
}
