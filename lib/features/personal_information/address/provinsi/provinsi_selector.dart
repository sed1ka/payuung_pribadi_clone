...
import 'package:payuung_pribadi_clone/features/personal_information/address/provinsi/provinsi_bottomsheet.dart';
import 'package:payuung_pribadi_clone/utils/formatter.dart';
import 'package:payuung_pribadi_clone/utils/page_navigator.dart';


class ProvinsiSelector extends StatelessWidget {
  const ProvinsiSelector({
    super.key,
  ...
  Future<void> selectData(
    ...
    final dynamic res = await showKreduitModalBottom(
      ...
      builder: (_) => BlocProvider.value(
        value: bloc,
        child: const ProvinsiBottomSheet(),
      ),
    );
  ...
  Widget build(BuildContext context) {
    final ProvinsiBloc bloc = BlocProvider.of(context);
    ...
    return BlocConsumer(
      ...
      builder: (_, __) => DataSelectorTextField(
        ...
        title: 'Provinsi',
        onTap: () => bloc.add(OpenSelectorProvinsi()),
      ),
    );
  }
}
