...
import 'package:payuung_pribadi_clone/features/personal_information/address/kelurahan/kelurahan_bottomsheet.dart';
import 'package:payuung_pribadi_clone/utils/formatter.dart';
import 'package:payuung_pribadi_clone/utils/page_navigator.dart';


class KelurahanSelector extends StatelessWidget {
  const KelurahanSelector({
    super.key,
  ...
  Future<void> selectData(
    ...
    final dynamic res = await showKreduitModalBottom(
      ...
      builder: (_) => BlocProvider.value(
        value: bloc,
        child: const KelurahanBottomSheet(),
      ),
    );
  ...
  Widget build(BuildContext context) {
    final KelurahanBloc bloc = BlocProvider.of(context);
    ...
    return BlocConsumer(
      ...
      builder: (_, __) => DataSelectorTextField(
        ...
        title: 'Kelurahan',
        onTap: () => bloc.add(OpenSelectorKelurahan()),
      ),
    );
  }
}
