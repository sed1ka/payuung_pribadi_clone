...
import 'package:payuung_pribadi_clone/features/personal_information/address/kecamatan/kecamatan_bottomsheet.dart';

import 'package:payuung_pribadi_clone/utils/formatter.dart';
import 'package:payuung_pribadi_clone/utils/page_navigator.dart';


class KecamatanSelector extends StatelessWidget {
  ...
  Future<void> selectData(
    ...
    final dynamic res = await showKreduitModalBottom(
      ...
      builder: (_) => BlocProvider.value(
        value: bloc,
        child: const KecamatanBottomSheet(),
      ),
    );
  ...
  Widget build(BuildContext context) {
    final KecamatanBloc bloc = BlocProvider.of(context);
    ...
    return BlocConsumer(
      ...
      builder: (_, __) => DataSelectorTextField(
        ...
        title: 'Kecamatan',
        onTap: () => bloc.add(OpenSelectorKecamatan()),
      ),
    );
  }
}
