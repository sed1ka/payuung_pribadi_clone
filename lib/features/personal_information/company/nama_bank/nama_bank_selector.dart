...
import 'package:payuung_pribadi_clone/features/personal_information/company/nama_bank/nama_bank_bottomsheet.dart';
import 'package:payuung_pribadi_clone/utils/formatter.dart';
import 'package:payuung_pribadi_clone/utils/page_navigator.dart';


class NamaBankSelector extends StatelessWidget {
  const NamaBankSelector({
    super.key,
  ...
  Future<void> selectData(
    ...
    final dynamic res = await showKreduitModalBottom(
      ...
      builder: (_) => BlocProvider.value(
        value: bloc,
        child: const NamaBankBottomSheet(),
      ),
    );
  ...
  Widget build(BuildContext context) {
    final NamaBankBloc bloc = BlocProvider.of(context);
    ...
    return BlocConsumer(
      ...
      builder: (_, __) => DataSelectorTextField(
        ...
        title: 'Nama Bank',
        onTap: () => bloc.add(OpenSelectorNamaBank()),
      ),
    );
  }
}
