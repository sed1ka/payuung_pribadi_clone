...
import 'package:payuung_pribadi_clone/features/personal_information/company/jabatan/jabatan_bottomsheet.dart';
import 'package:payuung_pribadi_clone/utils/formatter.dart';
import 'package:payuung_pribadi_clone/utils/page_navigator.dart';


class JabatanSelector extends StatelessWidget {
  const JabatanSelector({
    super.key,
  ...
  Future<void> selectData(
    ...
    final dynamic res = await showKreduitModalBottom(
      ...
      builder: (_) => BlocProvider.value(
        value: bloc,
        child: const JabatanBottomSheet(),
      ),
    );
  ...
  Widget build(BuildContext context) {
    final JabatanBloc bloc = BlocProvider.of(context);
    ...
    return BlocConsumer(
      ...
      builder: (_, __) => DataSelectorTextField(
        ...
        title: 'Jabatan',
        onTap: () => bloc.add(OpenSelectorJabatan()),
      ),
    );
  }
}
